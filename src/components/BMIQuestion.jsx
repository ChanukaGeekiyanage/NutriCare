...
function BMIQuestion() {
  ...
  const updateAndNavigate = () => {
    if (selectedBMI) {
      if (globalArray && globalArray.length >= 0) {
        ...
        navigate("/BSQuestion", { state: { array: globalArray } });
      } else {
        setShowWarning(true);
      }
    }
  ...
  return (
    <div
      ...
      className="body-containerb"
    >
      <div className="overlay">
        <Container maxWidth="md" style={{ marginBottom: "0px" }}>
          <div
            className="bmi-question-container"
              ...
              <Grid item xs={12} sm={6} style={{ marginLeft: "2px" }}>
                <div className="bmi-options-column">
                  ...
                  <Typography variant="h6" style={{ marginTop: "10px" }}>
                    Use the calculator if you don't know the BMI
                  </Typography>
                    ...
                    <FormControlLabel
                      control={
                        <Radio
                          ...
                          onChange={() =>
                            handleBMIChange({ target: { value: "Below 18.5" } })
                          }
                        />
                      }
                      label="Below 18.5"
                    ...
                    <FormControlLabel
                      control={
                        <Radio
                          ...
                          onChange={() =>
                            handleBMIChange({
                              target: { value: "Between 18.5 and 24.9" },
                            })
                          }
                        />
                      }
                    ...
                    <FormControlLabel
                      control={
                        <Radio
                          ...
                          onChange={() =>
                            handleBMIChange({
                              target: { value: "Between 25 and 29.9" },
                            })
                          }
                        />
                      }
                    ...
                    <FormControlLabel
                      control={
                        <Radio
                          ...
                          onChange={() =>
                            handleBMIChange({
                              target: { value: "Between 30 and 34.9" },
                            })
                          }
                        />
                      }
        ...
        <div className="next-button-containerb">
          <Button
