...
function BloodCholesterolLevelPage() {
  const [selectedCholesterolLevel, setSelectedCholesterolLevel] =
    useState(null);
  ...
  const updateAndNavigate = () => {
    if (globalArray && globalArray.length >= 0 && selectedCholesterolLevel) {
      ...
      navigate("/ActivityLevelQ", { state: { array: globalArray } });
    }
  };
        ...
        >
          <FormControlLabel
            ...
            control={
              <Radio
                checked={
                  selectedCholesterolLevel === "Normal range: 0-200 mg/dL"
                }
          ...
          <FormControlLabel
            ...
            control={
              <Radio
                checked={
                  selectedCholesterolLevel === "Borderline high: 200-240 mg/dL"
                }
                onChange={handleCholesterolLevelChange}
                value="Borderline high: 200-240 mg/dL"
                style={{ transform: "scale(1.5)", color: "white" }}
          ...
          <FormControlLabel
            ...
            control={
              <Radio
                checked={
                  selectedCholesterolLevel === "Very high: 300-500 mg/dL"
                }
                onChange={handleCholesterolLevelChange}
                value="Very high: 300-500 mg/dL"
                style={{ transform: "scale(1.5)", color: "white" }}
          ...
          <FormControlLabel
            ...
            control={
              <Radio
                checked={
                  selectedCholesterolLevel === "Extremely high: above 500 mg/dL"
                }
                onChange={handleCholesterolLevelChange}
                value="Extremely high: above 500 mg/dL"
                style={{ transform: "scale(1.5)", color: "white" }}
        ...
        <Grid item xs={12}>
          {selectedCholesterolLevel && (
            <Typography variant="body1">
              You selected: {selectedCholesterolLevel}
            </Typography>
          )}
        </Grid>
      </Grid>
