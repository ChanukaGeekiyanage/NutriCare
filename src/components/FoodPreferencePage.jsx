...
const foodOptions = [
  {
    ...
    title: "Vegetarian",
    content:
      "Vegetarianism involves abstaining from consuming meat, fish, and poultry...",
  },
  {
    value: "F2",
    image: veganImage,
    title: "Vegan",
    content:
      "Veganism takes vegetarianism a step further by excluding all animal products...",
  },
  {
    value: "F3",
    image: nonVegImage,
    title: "Non-Veg",
    content:
      "Non-vegetarian diets include the consumption of meat, fish, poultry, and seafood...",
  },
  {
    value: "F4",
    image: halalImage,
    title: "Halal",
    content:
      "Halal refers to foods that are permissible and lawful according to Islamic dietary laws...",
  },
  {
    value: "F5",
    image: paleoImage,
    title: "Paleo",
    content:
      "The Paleo diet is inspired by the dietary patterns of our ancient ancestors from the Paleolithic era...",
  },
];
...
function FoodPreferencePage() {
  ...
  return (
    <div className="food-preference-page-container">
      <Typography variant="h4" style={{ color: "white", marginTop: "40px" }}>
          ...
          <Grid item xs={6} sm={3} key={option.value}>
            <Paper
              className={`option-container ${
                selectedFoodPreference === option.value ? "selected" : ""
              }`}
      ...
      <div className="navigation-buttons" style={{ marginTop: "280px" }}>
        <Link to="/genderQuestion" style={{ marginRight: "10px" }}>
          <Button
            variant="contained"
            color="primary"
        ...
        <Link to="/recommendation">
          <Button
            ...
            style={{ background: "white", color: "black" }}
          >
            Get Personalized recommendation for me
          </Button>
        </Link>
      </div>
    </div>
