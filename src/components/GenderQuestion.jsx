...
function GenderQuestion() {
  ...
  const addItem = () => {
    if (selectedGender) {
      ...
      navigate("/BMIQuestion", { state: { array: globalArray } });
    }
  };
    ...
    <ThemeProvider theme={customTheme}>
      ...
      >
        <div className="overlay">
          <div className="gender-question-container" style={{ padding: "5px" }}>
            <img src={logoImage} alt="Logo" className="logo-image" />
            <Typography variant="h4" className="gender-question-containerh1">
              What is your Gender?
            </Typography>
